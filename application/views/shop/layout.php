...
<head>
  ...
  <meta name="author" content="Kresna Hendri">
	<title>PT Aneka Sinar Abadi | <?php echo $data['title'] ?></title>
...
<body>
	...
	<nav class="navbar navbar-default">
	  <div class="container">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="<?php echo site_url('shop') ?>">PT Aneka Sinar Abadi</a>
	    </div>

	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav navbar-right">
	        <li><a href="<?php echo site_url('payment-confirmation') ?>">Payment Confirmation</a></li>
	        <li><a href="<?php echo site_url('shop/about') ?>">About Company</a></li>
	...
	<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019. PT. Aneka Sinar Abadi</p>
					<p class="pull-right">Product By <span>PT. Aneka Sinar Abadi</span></p>
				</div>
			</div>
		</div>
